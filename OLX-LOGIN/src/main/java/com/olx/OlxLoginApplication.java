...
@EnableMongoRepositories(basePackageClasses = BlackListTokenRepo.class)
@EnableJpaRepositories(excludeFilters = 
@ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = BlackListTokenRepo.class))
